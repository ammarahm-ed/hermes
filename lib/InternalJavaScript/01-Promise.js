/* @nolint */var initPromise = (function () {
  ...
  class Promise {
    ...
    static allSettled(iterable) {
      ...
      // NamedEvaluation and infer the names from the keys.
    ...
    static any(values) {
      ...
      // per element with its own [[AlreadyCalled]] flag.
    ...
    // Spec step 3 calls SpeciesConstructor(this, %Promise%); we
      ...
      if (typeof onFinally !== 'function') {
        ...
        // constructors. Use helper function to prevent name
        // inference from variable assignment.
